create table MudancaCategoriasExtensoes (
id int identity(1,1) primary key,
dataHora smalldatetime not null)
go
create index MudancaCategoriasExtensoes_ID01 on MudancaCategoriasExtensoes (dataHora)
go

create trigger Extensao_TG01 on Extensao
...
create proc pr_MudancaCategoriasExtensoes_sel_Max
WITH EXECUTE AS OWNERASSET NOCOUNT ON
begin
select MAX(dataHora) from MudancaCategoriasExtensoes (nolock)
end
go
...
SET @GenerateProcsFor = 'MudancaCategoriasExtensoes'
