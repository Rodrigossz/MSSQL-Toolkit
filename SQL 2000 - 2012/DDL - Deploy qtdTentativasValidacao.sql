use PsafeDb
go
alter table Indicacao add qtdTentativasValidacao smallint null
go

update Indicacao set qtdTentativasValidacao = 0 where statusEmailId = 1
update Indicacao set qtdTentativasValidacao = 1 where statusEmailId = 2
update Indicacao set qtdTentativasValidacao = 0 where statusEmailId = 3
update Indicacao set qtdTentativasValidacao = 1 where statusEmailId = 4
update Indicacao set qtdTentativasValidacao = 0 where statusEmailId = 5
go
...
order by i.qtdTentativasValidacao, i.id 
...
SET @GenerateProcsFor = 'Indicacao'
