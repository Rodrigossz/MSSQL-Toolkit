...
( NAME = DbaDbDev1 , FILENAME = 'd:\DBA\SQLFiles\DBA_PP_ODS1.mdf', size = 50,FILEGROWTH =10% ),
( NAME = DbaDbDev2 , FILENAME = 'e:\DBA\SQLFiles\DBA_PP_ODS2.ndf', size = 50,FILEGROWTH =10% ) LOG ON
( NAME = DbaDbLog1 , FILENAME = 'f:\DBA\SQLFiles\DBA_PP_ODS1.ldf', size = 50,FILEGROWTH =10% )
go
...
ALTER AUTHORIZATION ON DATABASE::pSafeDb TO sa;
ALTER AUTHORIZATION ON DATABASE::DbaDb TO sa;

exec xp_cmdshell 'mkdir c:\Dba\Backup\DBPPGXC001' -- OLHA O NOME! ACERTAR!


-- tempdb
ALTER DATABASE tempdb MODIFY FILE ( NAME = tempdev , FILENAME = 'd:\DBA\SQLFiles\tempdb_PP_ODS1.mdf', size = 100,FILEGROWTH =10% )
ALTER DATABASE tempdb add FILE ( NAME = tempdev2 , FILENAME = 'e:\DBA\SQLFiles\tempdb_PP_ODS2.ndf', size = 100,FILEGROWTH =10% )
ALTER DATABASE tempdb MODIFY FILE ( NAME = templog , FILENAME = 'f:\DBA\SQLFiles\tempdb_PP_ODS1.ldf', size = 100,FILEGROWTH =10% )
...
-- SEMPRE TEM,MAS O NOME MUDA
exec sp_addrolemember 'ODSDbRole','GRUPOXANGO\IIS_INT';
end -- INT
